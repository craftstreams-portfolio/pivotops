      ...
      <header className="sticky top-0 z-30 border-b border-zinc-900 bg-zinc-950/90 backdrop-blur-sm">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm text-zinc-400">
            ...
            <a href="https://calendly.com/craftstreams/new-meeting" target="_blank" rel="noopener noreferrer"
              className="px-3.5 py-1.5 rounded-lg border border-emerald-500/40 text-emerald-400 text-xs font-semibold hover:bg-emerald-500/10 transition">
              Request a Demo
            </a>
          </nav>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2 text-sm text-zinc-500">
                ...
                <a href="/legal/security" className="block hover:text-white transition">Security</a>
