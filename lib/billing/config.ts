...
export const PLAN_FEATURES: Record<PlanTier, {
  ...
  free: {
    ...
    customIntegrations: false, prioritySupport: false, whiteLabel: false,
  },
  starter: {
    ...
    showcase: false, spotlight: false, pivotsos: false, workflows: false,
    customIntegrations: false, prioritySupport: false, whiteLabel: true,
  },
  professional: {
  ...
  enterprise: {
    ...
    customIntegrations: true, prioritySupport: true, whiteLabel: true,
  },
};
